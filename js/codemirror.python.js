! function(e) {
	...
	var v = k(["and", "or", "not", "is"]),
		_ = ["as", "assert", "break", "class", "continue", "def", "del", "elif", "else", "except", "finally", "for", "from", "global", "if", "import", "lambda", "pass", "raise", "return", "try", "while", "with", "yield", "in"],
	...
	x.registerHelper("hintWords", "python", _.concat(z)), x.defineMode("python", function(t, l) {
		...
		var c = l.hangingIndent || t.indentUnit,
			n = _,
			r = z;
		null != l.extra_keywords && (n = n.concat(l.extra_keywords)), null != l.extra_builtins && (r = r.concat(l.extra_builtins));
		var u, f, p = !(l.version && Number(l.version) < 3);
		f = p ? (u = l.identifiers || /^[_A-Za-z\u00A1-\uFFFF][_A-Za-z0-9\u00A1-\uFFFF]*/, n = n.concat(["nonlocal", "False", "True", "None", "async", "await"]), r = r.concat(["ascii", "bytes", "exec", "print"]), new RegExp("^(([rbuf]|(br)|(rb)|(fr)|(rf))?('{3}|\"{3}|['\"]))", "i")) : (u = l.identifiers || /^[_A-Za-z][_A-Za-z0-9]*/, n = n.concat(["exec", "print"]), r = r.concat(["apply", "basestring", "buffer", "cmp", "coerce", "execfile", "file", "intern", "long", "raw_input", "reduce", "reload", "unichr", "unicode", "xrange", "False", "True", "None"]), new RegExp("^(([rubf]|(ur)|(br))?('{3}|\"{3}|['\"]))", "i"));
		var d = k(n),
			m = k(r);

		function i(e, t) {
			var n = e.sol() && "\\" != t.lastToken;
			if (n && (t.indent = e.indentation()), n && "py" == w(t).type) {
				n = w(t).offset;
				if (e.eatSpace()) {
					var r = e.indentation();
					return n < r ? b(t) : r < n && y(e, t) && "#" != e.peek() && (t.errorToken = !0), null
				}
				r = h(e, t);
				return 0 < n && y(e, t) && (r += " " + s), r
			}
			return h(e, t)
		}
		...
		function h(e, t, n) {
			...
			if (e.match(f)) {
				...
				return t.tokenize = (r ? function(n, r) {
			...
			return e.match(o) ? "punctuation" : "." == t.lastToken && e.match(u) ? "property" : e.match(d) || e.match(v) ? "keyword" : e.match(m) ? "builtin" : e.match(/^(self|cls)\b/) ? "variable-2" : e.match(u) ? "def" == t.lastToken || "class" == t.lastToken ? "def" : "variable" : (e.next(), n ? null : s)
		}
		...
		function g(e, t) {
			...
			var n, r, i, o = t.tokenize(e, t),
				a = e.current();
			if (t.beginningOfLine && "@" == a) return e.match(u, !1) ? "meta" : p ? "operator" : s;
			if (/\S/.test(a) && (t.beginningOfLine = !1), "variable" != o && "builtin" != o || "meta" != t.lastToken || (o = "meta"), "pass" != a && "return" != a || (t.dedent = !0), "lambda" == a && (t.lambda = !0), ":" == a && !t.lambda && "py" == w(t).type && e.match(/^\s*(?:#|$)/, !1) && b(t), 1 == a.length && !/string|comment/.test(o)) {
				...
				if (-1 != l && (n = e, r = t, i = "])}".slice(l, l + 1), n = n.match(/^[\s\[\{\(]*(?:#|$)/, !1) ? null : n.column() + 1, r.scopes.push({
					...
					t.indent = t.scopes.pop().offset - c
				}
			}
		...
		return {
			...
			indent: function(e, t) {
				...
				var n = w(e),
					t = n.type == t.charAt(0) || "py" == n.type && !e.dedent && /^(else:|elif |except |finally:)/.test(t);
				return null != n.align ? n.align - (t ? 1 : 0) : n.offset - (t ? c : 0)
			},
